    ...
    <div class="flex min-h-screen w-full lg:w-1/2 lg:shrink-0 flex-col justify-center bg-[#FFFBF7] px-6 py-10 sm:px-10 sm:py-14 lg:px-16 lg:py-16">
        <div class="mx-auto w-full max-w-md rounded-2xl border border-[#E5DDD3] bg-white p-6 shadow-lg sm:p-8 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
            ...
            <form wire:submit="request" class="space-y-6">
                <div class="[&_.fi-input-wrapper]:!rounded-xl [&_.fi-input-wrapper]:!border-[#E5DDD3] [&_.fi-input-wrapper]:!py-3 [&_.fi-input-wrapper]:!shadow-sm [&_.fi-input-wrapper]:focus-within:!border-[#8B4513] [&_.fi-input-wrapper]:focus-within:!ring-2 [&_.fi-input-wrapper]:focus-within:!ring-[#8B4513]/30">
                    {{ $this->form }}
                </div>

                <button type="submit"
                    class="w-full rounded-xl bg-[#8B4513] px-6 py-3.5 text-sm font-semibold text-white shadow-md transition hover:bg-[#6B3410] active:scale-[0.98]"
