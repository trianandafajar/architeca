<div class="fixed inset-0 flex min-h-screen w-screen font-sans" x-data="{ showPassword: false }">
    ...
    <div
        ...
        <div
            class="mx-auto w-full max-w-md border border-[#E5DDD3] bg-white rounded-2xl p-4 shadow-lg sm:p-8 lg:border-none lg:bg-transparent lg:p-0 lg:shadow-none">
            ...
            <div class="rounded-2xl p-4 sm:p-8 lg:border-none lg:bg-transparent lg:p-0 lg:shadow-none">
                <h1 class="mb-2 text-2xl font-bold text-[#2D1810] lg:text-[#2D1810]">Welcome back</h1>
                <p class="mb-8 text-sm text-[#8B7355] lg:text-[#8B7355]">Enter your credentials to access your account.
                </p>
                ...
                <form wire:submit="authenticate" class="space-y-6">
                    ...
                    <div>
                        <label for="data.email" class="mb-2 block text-sm font-medium text-[#2D1810]">Email
                            address</label>
                    ...
                    <div>
                        ...
                        <div style="position: relative;">
                            <x-heroicon-o-lock-closed class="h-5 w-5 text-[#B8A98F]"
                                style="position: absolute; left: 14px; top: 50%; transform: translateY(-50%); pointer-events: none;" />
                            <input :type="showPassword ? 'text' : 'password'" id="data.password"
                                wire:model="data.password" placeholder="Enter your password" required
                                class="w-full rounded-xl border border-[#E5DDD3] bg-white py-3 text-sm text-[#2D1810] placeholder-[#B8A98F] shadow-sm transition focus:border-[#8B4513] focus:outline-none focus:ring-2 focus:ring-[#8B4513]/30"
