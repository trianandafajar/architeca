...
<x-filament::modal id="logout-modal" width="md" alignment="center">
    <x-slot name="heading">
        <div class="w-full text-center">Confirm Logout</div>
    </x-slot>

    <x-slot name="description">
        <div class="w-full text-center">Are you sure you want to log out of the application?</div>
    </x-slot>
